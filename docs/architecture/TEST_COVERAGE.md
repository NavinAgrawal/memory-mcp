...
- `src/search/SemanticSearch.ts` → Expected test: `tests/unit/search/SemanticSearch.test.ts`

### utils/

- `src/utils/entityUtils.ts` → Expected test: `tests/unit/utils/entityUtils.test.ts`
- `src/utils/formatters.ts` → Expected test: `tests/unit/utils/formatters.test.ts`
- `src/utils/schemas.ts` → Expected test: `tests/unit/utils/schemas.test.ts`
- `src/utils/searchAlgorithms.ts` → Expected test: `tests/unit/utils/searchAlgorithms.test.ts`
...
|-------------|------------|
| `core/EntityManager.ts` | `operation-progress.test.ts`, `workflows.test.ts`, `benchmarks.test.ts`, `optimization-benchmarks.test.ts`, `task-scheduler-benchmarks.test.ts`, `task-scheduler-config-benchmarks.test.ts`, `write-performance.test.ts`, `ConcurrencyControl.test.ts`, `EntityManager.test.ts`, `ManagerContext.test.ts`, `RelationManager.test.ts`, `CompressionManager.test.ts`, `BasicSearch.test.ts`, `BooleanSearch.test.ts`, `FuzzySearch.test.ts`, `RankedSearch.test.ts` |
| `core/GraphEventEmitter.ts` | `GraphEventEmitter.test.ts`, `GraphEvents.test.ts`, `TFIDFEventSync.test.ts` |
| `core/GraphStorage.ts` | `backup-compression.test.ts`, `compression-optimization.test.ts`, `operation-progress.test.ts`, `streaming-export.test.ts`, `worker-pool-integration.test.ts`, `workflows.test.ts`, `benchmarks.test.ts`, `compression-benchmarks.test.ts`, `optimization-benchmarks.test.ts`, `task-scheduler-benchmarks.test.ts`, `task-scheduler-config-benchmarks.test.ts`, `write-performance.test.ts`, `BatchTransaction.test.ts`, `ConcurrencyControl.test.ts`, `EntityManager.test.ts`, `GraphEventEmitter.test.ts`, `GraphEvents.test.ts`, `GraphStorage.test.ts`, `GraphTraversal.test.ts`, `HierarchyManager.test.ts`, `ObservationManager.test.ts`, `RelationManager.test.ts`, `StorageFactory.test.ts`, `TransactionBatching.test.ts`, `TransactionManager.test.ts`, `AnalyticsManager.test.ts`, `ArchiveManager.test.ts`, `CompressionManager.test.ts`, `IOManager.test.ts`, `BasicSearch.test.ts`, `BooleanSearch.test.ts`, `FuzzySearch.test.ts`, `IncrementalTFIDF.test.ts`, `RankedSearch.test.ts`, `SavedSearchManager.test.ts`, `SearchManager.test.ts`, `SearchSuggestions.test.ts`, `TFIDFEventSync.test.ts` |
| `core/GraphTraversal.ts` | `GraphTraversal.test.ts` |
| `core/HierarchyManager.ts` | `EntityManager.test.ts`, `HierarchyManager.test.ts`, `ManagerContext.test.ts` |
| `core/ManagerContext.ts` | `edge-cases.test.ts` |
| `core/ObservationManager.ts` | `write-performance.test.ts`, `ConcurrencyControl.test.ts`, `ManagerContext.test.ts`, `ObservationManager.test.ts` |
| `core/RelationManager.ts` | `workflows.test.ts`, `benchmarks.test.ts`, `ManagerContext.test.ts`, `RelationManager.test.ts`, `CompressionManager.test.ts`, `BasicSearch.test.ts`, `BooleanSearch.test.ts`, `FuzzySearch.test.ts` |
| `core/SQLiteStorage.ts` | `ConcurrencyControl.test.ts`, `SQLiteStorage.test.ts`, `StorageFactory.test.ts` |
| `core/StorageFactory.ts` | `StorageFactory.test.ts` |
| `core/TransactionManager.ts` | `operation-progress.test.ts`, `BatchTransaction.test.ts`, `TransactionBatching.test.ts`, `TransactionManager.test.ts` |
...
| `search/BasicSearch.ts` | `workflows.test.ts`, `benchmarks.test.ts`, `BasicSearch.test.ts`, `SavedSearchManager.test.ts` |
| `search/BooleanSearch.ts` | `workflows.test.ts`, `benchmarks.test.ts`, `BooleanSearch.test.ts` |
| `search/EmbeddingService.ts` | `EmbeddingService.test.ts` |
| `search/FuzzySearch.ts` | `worker-pool-integration.test.ts`, `workflows.test.ts`, `benchmarks.test.ts`, `FuzzySearch.test.ts` |
| `search/QueryCostEstimator.ts` | `QueryCostEstimator.test.ts` |
| `search/RankedSearch.ts` | `workflows.test.ts`, `benchmarks.test.ts`, `RankedSearch.test.ts` |
| `search/SavedSearchManager.ts` | `SavedSearchManager.test.ts` |
| `search/SearchFilterChain.ts` | `SearchFilterChain.test.ts` |
| `search/SearchManager.ts` | `ManagerContext.test.ts`, `SearchManager.test.ts` |
| `search/SearchSuggestions.ts` | `SearchSuggestions.test.ts` |
| `search/TFIDFEventSync.ts` | `IncrementalTFIDF.test.ts`, `TFIDFEventSync.test.ts` |
| `search/TFIDFIndexManager.ts` | `IncrementalTFIDF.test.ts`, `TFIDFEventSync.test.ts`, `TFIDFIndexManager.test.ts` |
| `search/VectorStore.ts` | `VectorStore.test.ts` |
...
| `utils/compressedCache.ts` | `compression-benchmarks.test.ts`, `compressedCache.test.ts` |
| `utils/compressionUtil.ts` | `compression-benchmarks.test.ts`, `IOManager.test.ts`, `compressionUtil.test.ts` |
| `utils/constants.ts` | `compression-benchmarks.test.ts`, `IOManager.test.ts`, `EmbeddingService.test.ts`, `responseCompressor.test.ts`, `compressionUtil.test.ts` |
| `utils/errors.ts` | `operation-progress.test.ts`, `EntityManager.test.ts`, `HierarchyManager.test.ts`, `ObservationManager.test.ts`, `RelationManager.test.ts`, `TransactionManager.test.ts`, `CompressionManager.test.ts`, `errors.test.ts`, `operationUtils.test.ts` |
| `utils/index.ts` | `entityUtils.test.ts`, `formatters.test.ts`, `schemas.test.ts`, `searchAlgorithms.test.ts` |
| `utils/indexes.ts` | `indexes.test.ts` |
| `utils/logger.ts` | `logger.test.ts` |
| `utils/operationUtils.ts` | `task-scheduler-config-benchmarks.test.ts`, `operationUtils.test.ts` |
| `utils/parallelUtils.ts` | `parallelUtils.test.ts` |
| `utils/searchCache.ts` | `searchCache.test.ts` |
| `utils/taskScheduler.ts` | `task-scheduler-config-benchmarks.test.ts`, `taskScheduler.test.ts` |
...
|-----------|---------------------|
| `tools/entity-tools.test.ts` | 2 files |
| `tools/observation-tools.test.ts` | 2 files |
| `tools/relation-tools.test.ts` | 2 files |
...
| `integration/server.test.ts` | 4 files |
...
| `core/ManagerContext.test.ts` | 11 files |
...
| `utils/schemas.test.ts` | 1 files |
| `utils/searchAlgorithms.test.ts` | 1 files |
