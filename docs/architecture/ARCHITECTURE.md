...
**Both circular-dependency counts are 0 and the search was not truncated**
(`circularDepsTruncated: false`), so these are true zeros rather than an unfinished search.
