...
38 test files, 798 tests, ~85% statement coverage (verified via `coverage/coverage-summary.json`: statements 84.8%, lines 86.1%, functions 84.8%, branches 69.8%). Core graph tests — and the bulk of coverage — live in the memoryjs package.
